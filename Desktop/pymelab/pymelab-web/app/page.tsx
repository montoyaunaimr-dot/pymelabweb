    ...
    <div ref={containerRef}>
      ...
      <section className="py-28 px-6 bg-[#0A0A0A] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          {/* ── Flow ── */}
          <div ref={caseRef} className="flex flex-col md:flex-row items-start justify-center gap-0 mb-14 overflow-x-auto pb-2">
            {caseFlow.map(({ num, title, desc, iconColor, iconBg, iconType }, i) => (
              <div key={i} className="flex flex-col md:flex-row items-center shrink-0">
                ...
                {/* Step */}
                <div className="case-step flex flex-col items-center text-center px-2" style={{ width: 130 }}>

                  {/* Number badge */}
                  <div
                    className="w-8 h-8 rounded-full border flex items-center justify-center mb-3 shrink-0"
                  ...
                  {/* Icon box */}
                  <div
                    className="w-[72px] h-[72px] rounded-2xl border flex items-center justify-center mb-4 shrink-0"
                    style={{ background: iconBg, borderColor: `${iconColor}25` }}
                  >
                    {iconType === 'whatsapp' && (
                    ...
                    {iconType === 'bot' && (
                      <Bot size={30} style={{ color: iconColor }} />
                    )}
                    {iconType === 'calendar' && (
                    ...
                    {iconType === 'calendar31' && (
                      <svg viewBox="0 0 24 24" className="w-8 h-8" fill="none">
                        ...
                        <rect x="3" y="4" width="18" height="5" rx="3" fill={iconColor} fillOpacity="0.5"/>
                        <text x="12" y="18" textAnchor="middle" fill={iconColor} fontSize="8" fontWeight="700">31</text>
                      </svg>
                    )}
                    {iconType === 'check' && (
                  ...
                  {/* Title */}
                  <p className="text-[10px] font-bold tracking-[0.08em] uppercase text-[#D0CCC6] mb-1.5 leading-snug whitespace-pre-line">
                    {title}
                  </p>

                  {/* Desc */}
                  <p className="text-[11px] text-[#3E3E3E] leading-relaxed whitespace-pre-line">
                    {desc}
                  </p>
                </div>
                ...
                {/* Arrow between steps */}
                {i < caseFlow.length - 1 && (
                  <div className="flex items-center justify-center mx-1 my-6 md:my-0 shrink-0" style={{ marginTop: '-32px' }}>
