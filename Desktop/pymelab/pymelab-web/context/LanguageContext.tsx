...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'about.p2':          'Somos un equipo apasionado por el diseño y la tecnología. Aunque somos una agencia joven, cada proyecto lo abordamos con la misma dedicación y exigencia que pondría una gran agencia — solo que sin sus precios.',
  ...
  en: {
    ...
    'about.p2':          'We are a team passionate about design and technology. Although we are a young agency, we approach every project with the same dedication and quality that a large agency would — just without their prices.',
